...
import { Trash2, BarChart2, Link as LinkIcon } from 'lucide-react';
        ...
        <>
            ...
            <div className="pb-12">
                <div className="flex items-center justify-between mb-8">
                    <h1 className="text-2xl font-bold text-white">Мої тести</h1>
                    <Link
                        to="/tests/create"
                ...
                {isLoading ? (
                    ...
                    <div className="grid gap-4">
                        {myTests?.map((test: any) => (
                            <div key={test.id} className="bg-[#1e1e1e] border border-[#2a2a2a] rounded-xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-colors hover:border-[#3a3a3a]">
                                <div>
